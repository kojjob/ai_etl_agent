class DashboardsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to dashboards_path, status: :see_other, notice: "Dashboard was successfully destroyed." }
  ...
  private
    ...
    def dashboard_params
      params.expect(dashboard: [ :user_id, :name, :description, :layout_config, :is_default, :is_shared, :shared_with_roles ])
    end
end
