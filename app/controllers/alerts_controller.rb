class AlertsController < ApplicationController
  ...
  private
    ...
    def alert_params
      params.expect(alert: [ :pipeline_id, :pipeline_run_id, :pipeline_step_run_id, :rule_id, :severity, :message, :status, :acknowledged_by_user_id, :acknowledged_at, :resolved_at ])
    end
end
